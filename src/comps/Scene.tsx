...
import { BG, FloppyDrive, Flops, Rig } from "./Flops";
...
export const SceneWrapper = () => {
    return (
        <div className="scene-wrapper">
            <Canvas camera={{ position: [0, 0, 200], fov: 22 }}>
                <pointLight castShadow intensity={0.7} position={[0, 0, 0]} />
                <Flops />
                <Rig />
            </Canvas>
        </div>
...
function Scene({ ...props }) {
    const { nodes, materials } = useSpline(
        "https://prod.spline.design/4mW2UXnYybgkK9Hx/scene.splinecode"
    );
    return (
        <>
