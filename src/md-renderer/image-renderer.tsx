...
export const ImageRenderer = (props: any) => {
    ...
    if (isFullSize) return <div className="image-renderer-open" onClick={() => setFullSize(false)}>
        <div className="close-btn"><FontAwesomeIcon icon={faTimes} /></div>

            <img className="image-renderer-open-image" src={props.src} />

    </div>
    else return <div className="image-renderer-con">
        <img className="image-renderer-image" src={props.src}
